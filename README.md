...
* This was a final project for UIUC's CS 225 course. I wrote everything except for the test file, make file, and the four simple "getter" functions that call member variables.
